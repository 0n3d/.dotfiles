...
M.setup = function()
    ...
    M.highlight("Normal", { fg = M.colors.white, bg = M.colors.black })
    ...
    M.highlight("QuickFixLine", { fg = M.colors.green, gui = "bold" })
    ...
    M.highlight("WinHighlight", { bg = M.colors.dark_black })
    ...
    M.highlight("HopNextKey", { fg = M.colors.green })
    M.highlight("HopNextKey1", { fg = M.colors.green })
    M.highlight("HopNextKey2", { fg = M.colors.special_grey })
end
